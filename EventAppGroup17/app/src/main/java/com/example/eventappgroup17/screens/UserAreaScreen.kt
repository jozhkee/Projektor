...
fun UserAreaScreen(
    ...
    if (eventToCancel != null) {
        AlertDialog(
            ...
            text = { Text("Remove your registration for \"${eventToCancel!!.title}\"?") },
            confirmButton = {
                TextButton(onClick = {
                    onCancelRegistration(eventToCancel!!.id)
                    events.remove(eventToCancel)
                    eventToCancel = null
                }) { Text("Cancel Registration") }
            },
            dismissButton = {
                TextButton(onClick = { eventToCancel = null }) { Text("Keep") }
            }
        )
    }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                ...
                Spacer(modifier = Modifier.height(4.dp))
                Text(
                    text = "My Registrations (${events.size})",
                ...
                items(events, key = { it.id }) { event ->
                    Card(
                        ...
                        Row(
                            ...
                            IconButton(onClick = { eventToCancel = event }) {
                                Icon(
